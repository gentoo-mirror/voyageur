...
SRC_URI="http://llvm.org/pre-releases/${PV/_pre*}/pre-release${PV/*_pre}/llvm-${PN}-${PV/_pre*}.tgz -> llvm-${PV}.tgz
	http://llvm.org/pre-releases/${PV/_pre*}/pre-release${PV/*_pre}/${PN}-${PV/_pre*}.tgz -> ${P}.tgz"
