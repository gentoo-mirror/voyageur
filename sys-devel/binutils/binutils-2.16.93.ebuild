...
src_unpack() {
	...
	epatch "${FILESDIR}/binutils-suse-hashvals.diff"
	epatch "${FILESDIR}/binutils-suse-bdirect.patch"
	epatch "${FILESDIR}/binutils-gentoo-dynsort.diff"
	epatch "${FILESDIR}/${P}-dtneeded-search-pr-ld2721.patch"
}
