...
# $Header: /var/cvsroot/gentoo-x86/dev-util/android-sdk-update-manager/android-sdk-update-manager-13.ebuild,v 1.1 2011/09/30 20:17:11 rich0 Exp $
...
src_install(){
	...
	SWT_PATH="`dirname \`java-config -p swt-3.6\``"
