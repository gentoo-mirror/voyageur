...
IUSE="largepages16k largepages32k largepages64k +debug llvm-libunwind minimal optimisememory test static-libs"
...
multilib_src_configure() {
	use largepages16k && append-cppflags -DTCMALLOC_PAGE_SIZE_SHIFT=14
	use largepages32k && append-cppflags -DTCMALLOC_PAGE_SIZE_SHIFT=15
	use largepages64k && append-cppflags -DTCMALLOC_PAGE_SIZE_SHIFT=16
