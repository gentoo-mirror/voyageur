...
DESCRIPTION="JDK and Java Plugin for 64 Bit Browsers"
HOMEPAGE="http://icedtea.classpath.org"
FEDORA_V="1.7.0.0-0.24.b24.fc9.x86_64"
BASE_URI="ftp://ftp.uni-bayreuth.de/pub/redhat.com/fedora/linux/development/x86_64/os/Packages"
...
pkg_postinst() {
	if [ $(gcc-version) != "4.2" ]; then
		...
		ewarn "set as currently active compiler whenever you want to use it!"
		ewarn "This includes the browser plugin!"
	fi
}
