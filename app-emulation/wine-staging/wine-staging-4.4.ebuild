...
COMMON_DEPEND="
	...
	faudio? ( media-sound/faudio:=[${MULTILIB_USEDEP}] )
...
PATCHES=(
	"${FILESDIR}/${MY_PN}-4.4-winegcc.patch" #260726
...
src_prepare() {
	...
	if use staging; then
		...
		local STAGING_EXCLUDE="-W xaudio2-revert -W xaudio2_CommitChanges -W xaudio2_7-WMA_support -W xaudio2_7-CreateFX-FXEcho"
