...
inherit autotools-utils eutils flag-o-matic user systemd wxwidgets

DESCRIPTION="The Berkeley Open Infrastructure for Network Computing"
HOMEPAGE="http://boinc.ssl.berkeley.edu/"
SRC_URI="https://github.com/BOINC/${PN}/archive/client_release/${PV%.*}/${PV}.tar.gz -> ${P}.tar.gz"
...
S="${WORKDIR}/${PN}-client_release-${PV%.*}-${PV}"
