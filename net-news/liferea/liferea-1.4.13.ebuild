...
# $Header: /var/cvsroot/gentoo-x86/net-news/liferea/liferea-1.4.13.ebuild,v 1.1 2008/03/04 00:22:29 dang Exp $
...
IUSE="dbus firefox gtkhtml gnutls libnotify lua networkmanager seamonkey webkit xulrunner"
...
RDEPEND="
	...
	webkit? ( >=net-libs/webkitgtk-28711 )
	>=x11-libs/gtk+-2.8
	x11-libs/pango
	>=gnome-base/gconf-2
